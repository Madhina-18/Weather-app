...
function Weather() 
{
    ...
    return (
        <div className="body p-28 flex justify-center  ">  {/*Overall Container Background*/}
            ...
            <div className="container w-64 p-8   m-30 justify-center  rounded-md shadow-2xl">
                ...
                <button   onClick={getWeather} className="bg-gray-600 p-2 mt-7 rounded-md text-white border
                 border-black hover:bg-blue-700 button ">Get Report</button>

                <div className=" font-bold text-[#E50022] mt-5">
